...
namespace Inventory.Server.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        readonly IUserEmailStore<Employee> _emailStore;
        ...
        public RegisterModel(
            ...
            IRepository<Station> _repository)
        {
        ...
        public void LoadLocations(IEnumerable<Station> m) => Stations = m.OrderBy(a => a.Name);        
        ...
        public async Task OnGetAsync(string returnUrl = null)
        {
            ...
            LoadLocations(await _repository.GetAllAsync(null));
        }
        ...
        async Task<Employee> CreateUser(InputModel m)
        {
            try
            {
                ...
                user.Rank = m.Rank;
                user.PayrollNumber = m.PayrollNumber;
                user.StationId = m.StationId;
        ...
        async Task GetExternalLogins() => ExternalLogins = (await _signInManager.GetExternalAuthenticationSchemesAsync()).ToList();        
    }
}